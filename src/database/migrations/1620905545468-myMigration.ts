...
export class myMigration1620905545468 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "invoice_model" DROP CONSTRAINT "FK_94159a6fa95bef7a1dc75efb29d"`,
      undefined,
    );
    await queryRunner.query(`DROP TABLE "customer_model"`, undefined);
    await queryRunner.query(`DROP TABLE "invoice_model"`, undefined);
    await queryRunner.query(
      `DROP TYPE "invoice_model_currency_enum"`,
      undefined,
    );
    await queryRunner.query(
      `DROP TYPE "invoice_model_paymentstatus_enum"`,
      undefined,
    );
  }
}
